...
// Categorização dos imports:

// Domain Layer: useAuthSignUp (lógica de negócio)
// UI Components: Screen, Header, Logo, SignUpForm (interface)
// Types: SignUpSchema (tipagem do formulário)
// Navigation: router (navegação)
// React Native: SafeAreaView (área segura)